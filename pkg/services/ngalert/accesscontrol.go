...
var (
	...
	notificationsReaderRole = accesscontrol.RoleRegistration{
		Role: accesscontrol.RoleDTO{
			...
			Description: "Read notification policies and contact points in Dashboard and external providers",
			Group:       AlertRolesGroup,
			Permissions: []accesscontrol.Permission{
				{
	...
	notificationsWriterRole = accesscontrol.RoleRegistration{
		Role: accesscontrol.RoleDTO{
			...
			Description: "Add, update, and delete contact points and notification policies in Dashboard and external providers",
			Group:       AlertRolesGroup,
	...
	alertingReaderRole = accesscontrol.RoleRegistration{
		Role: accesscontrol.RoleDTO{
			...
			Description: "Read alert rules, instances, silences, contact points, and notification policies in Dashboard and all external providers",
			Group:       AlertRolesGroup,
	...
	alertingWriterRole = accesscontrol.RoleRegistration{
		Role: accesscontrol.RoleDTO{
			...
			Description: "Add,update and delete alert rules, instances, silences, contact points, and notification policies in Dashboard and all external providers",
			Group:       AlertRolesGroup,
