...
run: $(BRA) ## Build and run web server on filesystem changes.
	@APP_NAME="nxtthing" APP_MODE="development" APP_PROTOCOL="http" APP_PORT="3000" ROOT_URL="http://localhost:3000/" POSTGRES_HOST="" \
	POSTGRES_PORT=5432 POSTGRES_DBNAME="dashboard" POSTGRES_USER="postgres" POSTGRES_PASSWORD="" SMTP_HOST="" \
	...
	DATASERVICE_URL="http://localhost:9003" DATASERVICE_TOKEN="" INFLUXDB_URL="localhost:8086" INFLUXDB_PWD="test" INFLUXDB_USER="influx" \
