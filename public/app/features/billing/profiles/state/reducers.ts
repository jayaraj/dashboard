...
const profilesSlice = createSlice({
  ...
  reducers: {
    setHasFetched: (state, action: PayloadAction<boolean>): ProfilesState => {
    ...
    setProfilesSearchQuery: (state, action: PayloadAction<string>): ProfilesState => {
      return { ...state, searchQuery: action.payload };
    },
    setProfilesSearchPage: (state, action: PayloadAction<number>): ProfilesState => {
      return { ...state, searchPage: action.payload };
    },
    setProfilesCount: (state, action: PayloadAction<number>): ProfilesState => {
      return { ...state, profilesCount: action.payload };
    },
  },
});

export const { profilesLoaded, setProfilesSearchQuery, setProfilesSearchPage, setProfilesCount } =
...
export const { slabsLoaded, setSlabsSearchPage, setSlabsSearchQuery, setSlabsCount } = slabsSlice.actions;
