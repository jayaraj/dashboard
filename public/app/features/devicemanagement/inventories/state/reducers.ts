...
import { InventoryConfigurationState, InventoryConfiguration } from 'app/types/devicemanagement/configuration';
...
const inventoriesSlice = createSlice({
  ...
  reducers: {
    setHasFetched: (state, action: PayloadAction<boolean>): InventoriesState => {
...
const inventoryConfigurationSlice = createSlice({
  ...
  reducers: {
    inventoryConfigurationLoaded: (
      state,
      action: PayloadAction<InventoryConfiguration>
