...
const GRAFANA_LOGO_LIGHT_URL = 'public/img/whitelabel/grafana_text_logo_light.svg';
const GRAFANA_LOGO_DARK_URL = 'public/img/whitelabel/grafana_text_logo_dark.svg';
