...
import { CustomPageHeader } from 'app/core/components/CustomPageHeader/CustomPageHeader';
...
export interface CustomDashboardPageRouteParams {
  uid?: string;
  type?: string;
  slug?: string;
}

type CustomDashboardPageRouteSearchParams = {
  tab?: string;
  folderId?: string;
  editPanel?: string;
  viewPanel?: string;
...
export interface CustomProps
  extends GrafanaRouteComponentProps<CustomDashboardPageRouteParams, CustomDashboardPageRouteSearchParams> {}
...
export type Props = Themeable2 & CustomProps & ConnectedProps<typeof connector>;
...
export class UnthemedCustomDashboardPage extends PureComponent<Props, State> {
  ...
  initDashboard() {
    const { dashboard, match, queryParams, loadDashboards, folderId } = this.props;
  ...
  render() {
    const { dashboard, initError, queryParams, theme, navModel } = this.props;
    ...
    return (
      <div className={containerClassNames}>
        ...
        <CustomPageHeader model={navModel} />
...
export const DashboardPage = withTheme2(UnthemedCustomDashboardPage);
