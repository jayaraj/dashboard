 ...
 */
export const FormElementsEditor: React.FC<Props> = ({ elements, onChange, sections }) => {
  /**
   * States
   */
  ...
  return (
    <div>
      ...
      <hr />
      <CollapsableSection label="New Element" isOpen={true} className={styles.collapsableSection}>
