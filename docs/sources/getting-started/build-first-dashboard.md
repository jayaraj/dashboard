...
1. Configure your [query]({{< relref "../panels/query-a-data-source/add-a-query/" >}}) by selecting `-- Datasource --` from the data source selector. This generates the Random Walk dashboard.
